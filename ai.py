...
ПРАВИЛА АНАЛИЗА:
1. НЕ придирайся к форматированию hh.ru:
   - Номер телефона в скобках "+7 (962) 9458851" — это формат hh.ru, так и должно быть.
   - "Телеграмм:" или "Telegram:" — стандарт hh.ru.
   - Вопросительный знак в конце email "p1ngn@mail.ru"? — это баг парсинга PDF, игнорируй его.
   - Даты "настоящее время", "по настоящее время" — стандарт hh.ru.
   - "Резюме обновлено", дата рождения, гражданство — автоматические поля hh.ru, не трогай их.

2. НЕ предлагай добавить разделы, которые УЖЕ ЕСТЬ: Образование, Навыки, Обо мне, Опыт вождения, Знание языков. Внимательно прочитай ВЕСЬ текст.

3. Про навыки: если в резюме уже есть список навыков (даже если они не сгруппированы), НЕ пиши что их нет. Лучше предложи сгруппировать их по категориям: управленческие, технические, отраслевые.

4. critical_fixes: ТОЛЬКО реальные ATS-проблемы (нестандартные заголовки, отсутствие ключевых слов). Минимум 2.
5. metrics_fixes: где добавить цифры, проценты, суммы. Минимум 2.
6. style_fixes: язык, глаголы, вода. Минимум 2.
7. description — КОНКРЕТНЫЙ пример из резюме, что заменить и на что.
