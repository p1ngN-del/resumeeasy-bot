...
{{
  "blocks": [
    ...
    {{"title": "Опыт работы", "text": "РАЗБЕЙ ПО КОМПАНИЯМ:\\n\\nКомпания 1, должность, даты:\\n• достижение\\n• достижение\\n\\nКомпания 2, должность, даты:\\n• достижение\\n• достижение"}},
...
- НЕ меняй контакты, телефон, email.
- Опыт работы ОБЯЗАТЕЛЬНО разбей по компаниям с абзацами.
- Навыки — одной строкой через запятую.
- Желаемая должность — ТОЛЬКО название должности.
