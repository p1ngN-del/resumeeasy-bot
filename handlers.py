...
{{"blocks": [{{"title": "Заголовок и контакты", "old_text": "ВЕСЬ текст заголовка и контактов из резюме", "new_text": "ВЕСЬ текст с улучшениями", "changes": "что изменилось"}}, {{"title": "Опыт работы", "old_text": "ВЕСЬ текст опыта из резюме", "new_text": "ВЕСЬ текст с улучшениями", "changes": "что изменилось"}}, {{"title": "Навыки", "old_text": "ВСЕ навыки из резюме", "new_text": "ВСЕ навыки с улучшениями", "changes": ""}}, {{"title": "Образование", "old_text": "ВЕСЬ текст образования из резюме", "new_text": "ВЕСЬ текст с улучшениями", "changes": ""}}, {{"title": "Обо мне", "old_text": "ВЕСЬ текст Обо мне из резюме", "new_text": "ВЕСЬ текст с улучшениями", "changes": ""}}], "summary": "Итог", "overall_score": 0, "ats_score": 0}}

СМЕРТЕЛЬНЫЕ ПРАВИЛА:
1. old_text и new_text должны содержать ПОЛНЫЙ текст каждого блока, а не одну строчку.
2. КАТЕГОРИЧЕСКИ НЕЛЬЗЯ придумывать: названия компаний (ООО, ЗАО, ИП), университеты (МГУ, ВШЭ), должности, цифры, имена. ТОЛЬКО то, что ЕСТЬ в исходном резюме.
3. Если в исходном резюме компания "Курский электроаппаратный завод, ЗАО" — пиши ТОЛЬКО её. НЕ заменяй на "ООО ТехноЛогистика" или любые другие.
4. Если в исходном резюме вуз "Российский институт политических технологий и бизнеса" — пиши ТОЛЬКО его. НЕ заменяй на "МГУ" или любые другие.
5. Если сомневаешься — НЕ МЕНЯЙ. Оставь как было.
