...
{{
  "blocks": [
    ...
    {{"title": "Опыт работы", "text": "Компания:\\nНазвание компании\\n\\nДолжность:\\nНазвание должности\\n\\nПериод:\\nДаты\\n\\n• достижение\\n• достижение\\n\\n---\\n\\nКомпания:\\nНазвание компании\\n\\nДолжность:\\nНазвание должности\\n\\nПериод:\\nДаты\\n\\n• достижение"}},
    {{"title": "Образование", "text": "образование"}},
    {{"title": "Навыки", "text": "навыки — через запятую, одной строкой"}},
    {{"title": "Обо мне", "text": "дополнительная информация"}}
  ],
...
ПРАВИЛА:
- Опыт работы ОБЯЗАТЕЛЬНО разбей по схеме: Компания → Должность → Период → достижения.
- Между компаниями ставь разделитель "---".
- Достижения добавляй через буллиты (•).
- Новые или изменённые достижения помечай символом ⭐ в начале строки.
- НЕ придумывай компании, должности, цифры. ТОЛЬКО из резюме.
